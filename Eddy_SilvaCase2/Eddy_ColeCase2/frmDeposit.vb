...
Public Class frmDeposit
    Private Sub frmDeposit_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'fkey = New frmKeypad(GlobalSettings.DisplayMode)
        'Panel1.Controls.Add(fkey)
    ...
    Private Sub btnToChecking_Click(sender As Object, e As EventArgs) Handles btnToChecking.Click
        ...
        NewBalance = GlobalSettings.CurrentChecking.MakeDeposit(Convert.ToDouble(txtValue.Text))
    End Sub

    Private Sub btnToSavings_Click(sender As Object, e As EventArgs) Handles btnToSavings.Click
        Dim NewBalance As Double
        NewBalance = GlobalSettings.CurrentSaving.MakeDeposit(Convert.ToDouble(txtValue.Text))
    End Sub
