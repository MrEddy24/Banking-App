...
Public Class frmMakeWithdrawal
    ...
    Private Sub btnToChecking_Click(sender As Object, e As EventArgs) Handles btnToChecking.Click
        ...
        NewBalance = GlobalSettings.CurrentChecking.MakeWithdrawal(Convert.ToDouble(txtValue.Text))
    End Sub

    Private Sub btnToSavings_Click(sender As Object, e As EventArgs) Handles btnToSavings.Click
        Dim NewBalance As Double
        NewBalance = GlobalSettings.CurrentSaving.MakeWithdrawal(Convert.ToDouble(txtValue.Text))
    End Sub
